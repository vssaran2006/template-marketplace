...
describe("Template Market Place Spec",()=>{
    ...
    //     //jest.fn().mockImplementationOnce(() => TemplateService.getTemplates().resolve(mockData));
    //     //const promise = TemplateService.getTemplates().resolve(mockData);
    //     // component.initApp();
    //     // expect(component.state.LOAD_STATUS).toEqual("SUCCESS");
